...
CREATE USER employees_admin IDENTIFIED BY employees_admin;
GRANT CONNECT TO employees_admin;
GRANT CREATE SESSION GRANT ALL PRIVILEGE TO employees_admin;
GRANT UNLIMITED TABLESPACE TO employees_admin;
GRANT CONNECT, RESOURCE, DBA TO employees_admin;
GRANT
  SELECT,
  INSERT,
  UPDATE,
